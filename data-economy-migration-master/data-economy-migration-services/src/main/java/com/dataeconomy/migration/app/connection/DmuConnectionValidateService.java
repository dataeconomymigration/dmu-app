...
public class DmuConnectionValidateService {
	...
	public boolean validateConnectionDetails(DmuConnectionDTO connectionDto) throws DataMigrationException {
		if (StringUtils.equalsIgnoreCase(DmuConstants.HIVE, connectionDto.getConnectionGroup())) {
		...
		if (StringUtils.equalsIgnoreCase(DmuConstants.IMPALA, connectionDto.getConnectionGroup())) {
		...
		if (StringUtils.equalsIgnoreCase(DmuConstants.SPARK, connectionDto.getConnectionGroup())) { 
